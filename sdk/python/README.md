...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub organization/username):
   ...
   - find and replace all instances of the boilerplate `ngrok` with the `NAME` of your provider.
...
- binary: pulumi-resource-ngrok
  ...
  ignore: []
  ldflags:
  - -X github.com/pulumi/pulumi-ngrok/provider/pkg/version.Version={{.Tag}}
  main: ./cmd/pulumi-resource-ngrok/
  sort: asc
  use: git
release:
  disable: false
...
├── config.yaml
├── metadata.json
├── pulumi-ngrok_darwin_amd64_v1
│   └── pulumi-resource-ngrok
├── pulumi-ngrok_darwin_arm64
│   └── pulumi-resource-ngrok
├── pulumi-ngrok_linux_amd64_v1
│   └── pulumi-resource-ngrok
├── pulumi-ngrok_linux_arm64
│   └── pulumi-resource-ngrok
├── pulumi-ngrok_windows_amd64_v1
│   └── pulumi-resource-ngrok.exe
└── pulumi-ngrok_windows_arm64
    └── pulumi-resource-ngrok.exe
```
