...
__all__ = ['SshHostCertificateArgs', 'SshHostCertificate']

@pulumi.input_type
class SshHostCertificateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] ssh_certificate_authority_id: the ssh certificate authority that is used to sign this ssh host certificate
        ...
        :param pulumi.Input[str] description: human-readable description of this SSH Host Certificate. optional, max 255 bytes.
        :param pulumi.Input[str] key_type: the key type of the `public_key`, one of `rsa`, `ecdsa` or `ed25519`
        :param pulumi.Input[str] metadata: arbitrary user-defined machine-readable data of this SSH Host Certificate. optional, max 4096 bytes.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] principals: the list of principals included in the ssh host certificate. This is the list of hostnames and/or IP addresses that are authorized to serve SSH traffic with this certificate. Dangerously, if no principals are specified, this certificate is considered valid for all hosts.
...
@pulumi.input_type
class _SshHostCertificateState:
    def __init__(__self__, *,
                 certificate: Optional[pulumi.Input[str]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 key_type: Optional[pulumi.Input[str]] = None,
...
class SshHostCertificate(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param SshHostCertificateArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(SshHostCertificateArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = SshHostCertificateArgs.__new__(SshHostCertificateArgs)
        ...
        super(SshHostCertificate, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            ssh_certificate_authority_id: Optional[pulumi.Input[str]] = None,
            valid_after: Optional[pulumi.Input[str]] = None,
            valid_until: Optional[pulumi.Input[str]] = None) -> 'SshHostCertificate':
        """
        ...
        __props__ = _SshHostCertificateState.__new__(_SshHostCertificateState)
        ...
        __props__.__dict__["valid_after"] = valid_after
        __props__.__dict__["valid_until"] = valid_until
        return SshHostCertificate(resource_name, opts=opts, __props__=__props__)
