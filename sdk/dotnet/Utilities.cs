...
namespace PiersKarsenbarg.Ngrok
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("PiersKarsenbarg.Ngrok.version.txt");
    ...
    internal sealed class NgrokResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public NgrokResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
