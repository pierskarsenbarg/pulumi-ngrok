...
namespace PiersKarsenbarg.Ngrok.Inputs
{
    ...
    public sealed class EndpointConfigurationResponseHeaderArgs : global::Pulumi.ResourceArgs
    {
        [Input("add")]
        ...
        public EndpointConfigurationResponseHeaderArgs()
        {
        }
        public static new EndpointConfigurationResponseHeaderArgs Empty => new EndpointConfigurationResponseHeaderArgs();
    }
}
