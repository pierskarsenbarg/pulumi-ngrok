...
namespace PiersKarsenbarg.Ngrok.Inputs
{
    ...
    public sealed class EndpointConfigurationOauthGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("providers")]
        private InputList<Inputs.EndpointConfigurationOauthProviderGetArgs>? _providers;
        ...
        /// </summary>
        public InputList<Inputs.EndpointConfigurationOauthProviderGetArgs> Providers
        {
            get => _providers ?? (_providers = new InputList<Inputs.EndpointConfigurationOauthProviderGetArgs>());
            set => _providers = value;
        }

        public EndpointConfigurationOauthGetArgs()
        {
        }
        public static new EndpointConfigurationOauthGetArgs Empty => new EndpointConfigurationOauthGetArgs();
    }
}
